         ...
         <a href="{{ route('viewthisproduct', [ 'from_user' => $doc->from_user, 'id' => $doc->id, 'name' =>$doc->product_name]) }}" style="text-decoration: none;"><div class="col-sm-6 col-md-4">
            ...
            <center><strong>{{ $doc->price }}</strong></center>
              ...
              <div class="caption">
                ...
                <div class="pull-left price"><i class="fa fa-phone"></i>  
                <strong>{{ $doc->telephone }}</strong> 
                <i class="icon_clock_alt"></i><strong>{{ $doc->working_hours }}</strong>  
                <i class="icon_pin_alt"></i> <strong>{{ $doc->location }}</strong> </div>
