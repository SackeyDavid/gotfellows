                        ...
                        <div  class="panel" style="border: 1px solid #ddd;">
                          <div class="panel-heading" style="background-color: #fff;padding-bottom: 2px;padding-top: 1%;">
                           ...
                           {{ $post2->body }}
                            ...
                            @else
                            	<img alt="{{ $comment2->author['firstname'] }}" width="32" height="32" src="{{ URL::to('uploads/images/'.$comment2->author['featured_image']) }}" width="32" height="32" alt="{{ $comment2->author['firstname'] }}"/>
                            @endif
...
@endif
 ...
 @if(!$event->count())
      <div class="alert alert-info">
               <a href="#" data-dismiss="alert" class="close">&times;</a>
                <p style="font-size: 15px;"><center>Sorry {{ Auth::user()->firstname }}, till now your fellows haven't posted anything on events</center></p>
      </div> 
@else
@endif
@endsection