@section('fellows-event')
               ...
               <!-- <div class="alert alert-info">
               <a href="#" data-dismiss="alert" class="close">&times;</a>
                <p style="font-size: 15px;"><center>Sorry {{ Auth::user()->firstname }}, till now your fellows haven't posted anything on {{ $input }}</center></p>
                </div> -->
               @endif
                 @endforeach
                 @else
...
@endif
 ...
 @if(!$event->count())
      <div class="alert alert-info">
               <a href="#" data-dismiss="alert" class="close">&times;</a>
                <p style="font-size: 15px;"><center>Sorry {{ Auth::user()->firstname }}, till now your fellows haven't posted anything on {{ $input }} events</center></p>
      </div> 
@else
@endif
@endsection